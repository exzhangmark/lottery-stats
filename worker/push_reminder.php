<?php
/**
 * 开奖日 7:00 选号建议推送（独立脚本）
 *
 * 用法：
 *   php worker/push_reminder.php
 *
 * 典型部署：加到 crontab，每天 7:00 执行一次
 *   0 7 * * * /usr/bin/php /www/wwwroot/lottery/worker/push_reminder.php >> /www/wwwroot/lottery/data/reminder.log 2>&1
 *
 * 说明：
 *   - 仅当今天是双色球(周二/四/日)或大乐透(周一/三/六)开奖日时才推送，周五无开奖自动跳过；
 ...
 *   - 若 worker 常驻进程已在运行，它也会在 7:00 自行触发，本脚本作为冗余保险。
 */
